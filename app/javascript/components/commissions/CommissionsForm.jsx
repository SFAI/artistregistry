...
class CommissionsForm extends React.Component {
  ...
  componentDidMount = () => {
    ...
    Requester.get(commissions_types_route).then(
      response => {
  ...
  render() {
    ...
    if (!this.props.buyer) {
      return (
        <Panel color="denim" title="Contact the Artist">
          <div className="pa3">
            <p className="mb4">Log in to your account to contact artists.</p>
            <a className="pointer denim mb1" href="../artists/sign_in">
              Log in (Artist) »
            </a>
            <a className="pointer denim" href="../buyers/sign_in">
              Log in (Patron) »
            </a>
          </div>
        </Panel>
    ...
    return (
      <Panel color="denim" title="Contact the Artist">
        ...
        >
          {Object.keys(this.state.commissions_types).map((obj, i) => {
        ...
        <button
          ...
          className="button-primary bg-denim w4 mt2"
        >
          Submit
        </button>
      </Panel>
